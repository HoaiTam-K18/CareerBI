...
from logic.bronze_loader import load_bronze
from logic.silver_transformer import transform_silver
...
with DAG(
    ...
    task_dbt_run = BashOperator(
        ...
        # Chạy 2 lệnh:
        # 1. cd: Đi vào thư mục project dbt
        # 2. dbt run: Chạy tất cả model
